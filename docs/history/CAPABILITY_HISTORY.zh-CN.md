...
| Managed topology 调查 | Dated AWS/Render/Railway 比较、单 region managed persistence candidate、secret/workload identity 边界、RPF-28 Simulation hosting 约束、Product Release Identity、Approval/release chain、backup/restore、rollout/rollback、cost/backpressure 与 conditional RPF-37 scope | 没有创建 cloud account/resource/deployment；`READY_FOR_PRODUCTION_IMPLEMENTATION=CONDITIONAL`；不声明自动 `ELIGIBLE` deploy、Kubernetes、broker、multiregion 或完整 tenant/RBAC |
