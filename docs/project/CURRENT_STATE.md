...
- RPF-28 commit `6e0e2f6` also passed the existing hosted canonical Release Gate in [run `35193864849`](https://github.com/MyKr-YSteinsK/runproof/actions/runs/35193864849): fresh PostgreSQL/Control Plane durable evaluation, canonical Decision read-back, and redacted artifact upload completed in `1m9s`; artifact `rpf-12-release-gate-35193864849-1` has digest `sha256:05a443581ff528e5654656165f085c088fcee930684729f6be08bf497577df65`。It did not execute release/deploy; GitHub reported the existing action Node.js 20 and setup-java v4 deprecation warnings。
