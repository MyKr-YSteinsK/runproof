...
FAILURE_CASE_SCHEMA_VERSION = "rpf-failure-case-v1"
FAILURE_SIGNATURE_VERSION = "rpf-failure-signature-v1"
AGENT_OBSERVE_BEFORE_MUTATION = "RPF-AGENT-OBSERVE-BEFORE-MUTATION"
NO_BLIND_RETRY_AFTER_UNKNOWN_OUTCOME = "RPF-NO-BLIND-RETRY-AFTER-UNKNOWN-OUTCOME"
INITIAL_STATE = {
    "release": "release-v1",
    "revision": 0,
    "mutation_count": 0,
